...
description: "Start new projects with Mekong Marketing from scratch - bootstrap ideas into production-ready applications with AI agents."
...
```bash
# Create new project with Mekong Marketing Engineer kit
