...
**Chức năng:**
- Tải xuống bản phát hành Mekong Marketing được chỉ định
...
Mặc định, Mekong Marketing sử dụng cấu hình local (`~/.mekong`).
...
Cập nhật Mekong Marketing CLI lên phiên bản mới nhất:
...
# Bắt đầu sử dụng Mekong Marketing
